var gameOverLayer = cc.LayerColor.extend({
    ...
    init:function () {
        ...
        this.levelCompleteLabel = new cc.LabelTTF("Level Completed", "res/Quicksand-Light.ttf", winsize.height/12);
        ...
        this.againLabel = new cc.LabelTTF("You did it again!", "res/Quicksand-Light.ttf", winsize.height/12);
        ...
        this.highscoreLabel = new cc.LabelTTF("New Highscore!", "res/Quicksand-Light.ttf", winsize.height/12);
        ...
        this.newrankLabel = new cc.LabelTTF("New Rank!", "res/Quicksand-Light.ttf", winsize.height/12);
        ...
        this.closeLabel = new cc.LabelTTF(messages[Math.floor(Math.random()*7)], "res/Quicksand-Light.ttf", winsize.height/12);
        ...
        this.movesoverLabel = new cc.LabelTTF("Out of Moves", "res/Quicksand-Light.ttf", winsize.height/12);
        ...
        this.labelQuads = new cc.LabelTTF(this.quads+ " Quads"/* + " (" + (this.quads-levelsArray[this.ls.getItem(99)-1][3]) + ")"*/, "res/Quicksand-Light.ttf", winsize.height/10);
        ...
        this.labelQuadsBlue = new cc.LabelTTF(this.quadsBlue+ " Quads"/* + " (" + (this.quads-levelsArray[this.ls.getItem(99)-1][3]) + ")"*/, "res/Quicksand-Light.ttf", winsize.height/10);
        ...
        this.labelPoints = new cc.LabelTTF(this.points+" Points"/* + " (" + (this.points-levelsArray[this.ls.getItem(99)-1][5]) + ")"*/, "res/Quicksand-Light.ttf", winsize.height/10);
        ...
        this.movesLabel = new cc.LabelTTF(this.moves+" Moves" /*+ " (" + (this.moves-levelsArray[this.ls.getItem(99)-1][6]) + ")"*/, "res/Quicksand-Light.ttf", winsize.height/10);
        ...
        this.movesLeftLabel = new cc.LabelTTF(this.movesLeft+ " Left" ,"res/Quicksand-Light.ttf", winsize.height/10);
		...
		/*this.swipeLabel = new cc.LabelTTF("", "res/Quicksand-Light.ttf", winsize.height/12);
