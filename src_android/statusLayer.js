var statusLayer = cc.Layer.extend({
    ...
    init:function () {
        ...
        this.labelQuads = new cc.LabelTTF("", "res/Quicksand-Light.ttf", this.winsize.height/10);
        ...
        this.labelQuadsBlue = new cc.LabelTTF("", "res/Quicksand-Light.ttf", this.winsize.height/10);
        ...
        this.labelPoints = new cc.LabelTTF("", "res/Quicksand-Light.ttf", this.winsize.height/10);
        ...
        this.labelMoves = new cc.LabelTTF("", "res/Quicksand-Light.ttf", this.winsize.height/10);
        ...
        this.pauseLabel = new cc.LabelTTF("Pause", "res/Quicksand-Light.ttf" , this.winsize.height/10);
        this.pauseLabel.setColor(cc.color(0,0,0));
        this.pauseLabelP = new cc.LabelTTF("Pause", "res/Quicksand-Light.ttf", this.winsize.height/10);
