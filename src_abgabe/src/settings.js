var settingsLayer = cc.Layer.extend({
    ...
    init: function() {
        ...
        this.blinkHelpLabel = new cc.LabelTTF("Blink", "Quicksand-Light", winsize.height / 10);
        ...
        this.tutorialHelpLabel = new cc.LabelTTF("Tutorial", "Quicksand-Light", winsize.height / 10);
    ...
    positionMarker: function() {
        if (this.switcher.value == 0) { //Problems in Cocos2d-js listener not paused for first touch 
