var pauseLayer = cc.LayerColor.extend({
    ...
    init: function() {
        ...
        this.labelQuads = new cc.LabelTTF(this.quads + " Quads", "Quicksand-Light", winsize.height / 8);
        ...
        this.labelPoints = new cc.LabelTTF(this.points + " Points", "Quicksand-Light", winsize.height / 8);
        ...
        this.movesLabel = new cc.LabelTTF(this.moves + " Moves", "Quicksand-Light", winsize.height / 8);
        ...
        this.swipeLabel.setColor(cc.color(0, 0, 0));
        ...
        this.backLabel.setColor(cc.color(0, 0, 0));
