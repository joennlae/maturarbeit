var gameOverLayer = cc.LayerColor.extend({
    ...
    init: function() {
        ...
        this.labelQuads = new cc.LabelTTF(this.quads + " Quads", "Quicksand-Light", winsize.height / 10);
        ...
        this.labelQuadsBlue = new cc.LabelTTF(this.quadsBlue + " Quads", "Quicksand-Light", winsize.height / 10);
        ...
        this.labelPoints = new cc.LabelTTF(this.points + " Points", "Quicksand-Light", winsize.height / 10);
        ...
        this.movesLabel = new cc.LabelTTF(this.moves + " Moves", "Quicksand-Light", winsize.height / 10);
        ...
        if (this.quads >= levelsArray[this.ls.getItem(99) - 1][3]) {
            this.labelQuads.setString(this.quads + " Quads");
        ...
        if (this.moves < levelsArray[this.ls.getItem(99) - 1][6]) {
            this.movesLabel.setString(this.moves + " Moves");
