var settingsLayer = cc.Layer.extend({
    ...
    init:function(){
        ...
        this.backLabel = new cc.LabelTTF("Back", "res/Quicksand-Light.ttf" , winsize.height/8);
		...
		this.backLabelP = new cc.LabelTTF("Back", "res/Quicksand-Light.ttf", winsize.height/8);
        this.backLabelP.setColor(cc.color(0,0,150));

        this.helpLineLabel = new cc.LabelTTF("Lines", "res/Quicksand-Light.ttf" , winsize.height/10); 
        ...
        this.blinkHelpLabel = new cc.LabelTTF("Blink", "res/Quicksand-Light.ttf" , winsize.height/10); //ls.getnumber(201)
        ...
        this.tutorialHelpLabel = new cc.LabelTTF("Tutorial", "res/Quicksand-Light.ttf" , winsize.height/10); //ls.getnumber(206) 
        ...
        this.soundHelpLabel = new cc.LabelTTF("Music", "res/Quicksand-Light.ttf" , winsize.height/10); 
        ...
        this.halfLabel = new cc.LabelTTF("Half Size", "res/Quicksand-Light.ttf" , winsize.height/12);
        ...
        this.fullLabel = new cc.LabelTTF("Full Size", "res/Quicksand-Light.ttf" , winsize.height/12);
        ...
        this.positionMarkerHelpLabel = new cc.LabelTTF("Position Marker", "res/Quicksand-Light.ttf" , winsize.height/10); //ls.getnumber(201)
