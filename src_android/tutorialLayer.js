var tutorialLayer = cc.LayerColor.extend({
    ...
    init:function () {
        ...
        this.pointsLabel = new cc.LabelTTF("Points", "res/Quicksand-Light.ttf" , winsize.height/8);
        ...
        this.quadsLabel = new cc.LabelTTF("Quads", "res/Quicksand-Light.ttf" , winsize.height/8);
        ...
        this.movesLabel = new cc.LabelTTF("Moves", "res/Quicksand-Light.ttf" , winsize.height/8);
