var menuLayer = cc.Layer.extend({
    ...
    init:function(){
        ...
        this.settingsLabel = new cc.LabelTTF("Settings", "res/Quicksand-Light.ttf", this.winsize.height/10);
        this.settingsLabel.setColor(cc.color(0,0,0));//black color
        //this.startLabel.setPosition(cc.p(this.winsize.width/2, this.winsize.height/2));
        
        this.settingsLabelP = new cc.LabelTTF("Settings", "res/Quicksand-Light.ttf", this.winsize.height/10);
        this.settingsLabelP.setColor(cc.color(0,0,150));//blue color
        //this.startLabelP.setPosition(cc.p(this.winsize.width/2, this.winsize.height/2));
        
        this.messageLabel = new cc.LabelTTF(startUpMessages[Math.floor(Math.random()*(startUpMessages.length))], "res/Quicksand-Light.ttf", this.winsize.height/12);
