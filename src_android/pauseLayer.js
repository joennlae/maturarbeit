var pauseLayer = cc.LayerColor.extend({
    ...
    init:function () {
        ...
        this.labelQuads = new cc.LabelTTF(this.quads+ " Quads" /*+ " (" + (this.quads-levelsArray[this.ls.getItem(99)-1][3]) + ")"*/, "res/Quicksand-Light.ttf", winsize.height/8);
        ...
        this.labelQuadsBlue = new cc.LabelTTF(this.quads+ " Quads" , "res/Quicksand-Light.ttf", winsize.height/8);
        ...
        this.labelPoints = new cc.LabelTTF(this.points+" Points"/* + " (" + (this.points-levelsArray[this.ls.getItem(99)-1][5]) + ")"*/, "res/Quicksand-Light.ttf", winsize.height/8);
        ...
        this.movesLabel = new cc.LabelTTF(this.moves+" Moves"/* + " (" + (this.moves-levelsArray[this.ls.getItem(99)-1][6]) + ")"*/, "res/Quicksand-Light.ttf", winsize.height/8);
		...
		this.swipeLabel = new cc.LabelTTF("Swipe to continue", "res/Quicksand-Light.ttf", winsize.height/10);
        ...
        this.backLabel = new cc.LabelTTF("Back", "res/Quicksand-Light.ttf" , winsize.height/10);
        ...
        this.backLabelP = new cc.LabelTTF("Back", "res/Quicksand-Light.ttf", winsize.height/10);
