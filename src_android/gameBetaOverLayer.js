var gameBetaOverLayer = cc.LayerColor.extend({
    ...
    init:function () {
        ...
        this.labelQuads = new cc.LabelTTF(this.quads+ " Quads", "res/Quicksand-Light.ttf", 80);
        ...
        this.labelQuadsBlue = new cc.LabelTTF(this.quadsBlue+ " QuadsBlue", "res/Quicksand-Light.ttf", 80);
        ...
        this.labelPoints = new cc.LabelTTF(this.points+" Points", "res/Quicksand-Light.ttf", 80);
        ...
        this.movesLabel = new cc.LabelTTF(this.moves+" Moves", "res/Quicksand-Light.ttf", 80);
