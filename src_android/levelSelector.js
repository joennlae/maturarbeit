...
var levelSelector = cc.Layer.extend({
    ...
    init:function(){
		...
		this.levelLabel = new cc.LabelTTF(this.levelNum.value, "res/Quicksand-Light.ttf", this.winsize.height/8*5);
		...
		this.startLabel = new cc.LabelTTF("Play", "res/Quicksand-Light.ttf" , this.winsize.height/10);
        this.startLabel.setColor(cc.color(0,0,0));
		this.startLabelP = new cc.LabelTTF("Play", "res/Quicksand-Light.ttf", this.winsize.height/10);
        this.startLabelP.setColor(cc.color(0,0,150));
		
		this.controlRight = new cc.LabelTTF(">", "res/Quicksand-Light.ttf", this.winsize.height/4);
        this.controlRight.setColor(cc.color(120,120,120));
		this.controlRightP = new cc.LabelTTF(">", "res/Quicksand-Light.ttf", this.winsize.height/4);
        this.controlRightP.setColor(cc.color(0,0,0));
		this.controlRight.retain();
        this.controlRightP.retain();
		
        this.controlLeft = new cc.LabelTTF("<", "res/Quicksand-Light.ttf", this.winsize.height/4);
        this.controlLeft.setColor(cc.color(120,120,120));
		this.controlLeftP = new cc.LabelTTF("<", "res/Quicksand-Light.ttf", this.winsize.height/4);
        ...
        this.maxLabel = new cc.LabelTTF("Coming soon!", "res/Quicksand-Light.ttf", this.winsize.height/8);
        ...
        this.pointsLabel = new cc.LabelTTF("", "res/Quicksand-Light.ttf", this.winsize.height/12);
        ...
        this.quadsLabel = new cc.LabelTTF("", "res/Quicksand-Light.ttf", this.winsize.height/12);
        ...
        this.quadsBlueLabel = new cc.LabelTTF("", "res/Quicksand-Light.ttf", this.winsize.height/12);
        ...
        this.movesLabel = new cc.LabelTTF("", "res/Quicksand-Light.ttf", this.winsize.height/12);
        ...
        this.addChild(this.movesLabel);
       	...
       	this.rankLabel = new cc.LabelTTF("", "res/Quicksand-Light.ttf", this.winsize.height/12);
        ...
        this.questionLabel = new cc.LabelTTF("?", "res/Quicksand-Light.ttf", this.winsize.height/8);
        ...
        this.backLabel = new cc.LabelTTF("Back", "res/Quicksand-Light.ttf" , this.winsize.height/10);
        this.backLabel.setColor(cc.color(0,0,0));//black color
		this.backLabelP = new cc.LabelTTF("Back", "res/Quicksand-Light.ttf", this.winsize.height/10);
    ...
    updateStats : function(){
    	...
    	if (saveArray[this.levelNum.value-1][1] >= levelsArray[this.levelNum.value-1][3] || levelsArray[this.levelNum.value-1][9]==2 || levelsArray[this.levelNum.value-1][9]==3){
    		...
    		this.quadsLabel.setPosition(cc.p(this.winsize.width/4, this.winsize.height/10*8));
    		if(levelsArray[this.levelNum.value-1][9]==2 || levelsArray[this.levelNum.value-1][9]==3){
    			this.quadsLabel.setPosition(cc.p(this.winsize.width/4*0.8, this.winsize.height/10*8));
    		}
    	}
    	else {
    		this.quadsLabel.setPosition(cc.p(this.winsize.width/4, this.winsize.height/10*8));
